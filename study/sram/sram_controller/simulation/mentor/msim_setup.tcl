...
# ----------------------------------------
# If sram_controller is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 711 win32 2020.10.14.14:20:05
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sram_controller"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sram_controller.vhd"
}
